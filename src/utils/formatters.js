...
export const firstDay = () => `${today().slice(0, 8)}01`
...
export const money = (value) => rupiah.format(Number(value || 0))
...
export const apiPath = (path, values = {}) => {
...
export const parseNum = (v) => Number(String(v).replace(/\./g, '')) || 0
