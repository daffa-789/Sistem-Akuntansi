...
import { exportJournalToExcel } from '../../services/excelExporter.js'

export function JournalReportView({ accounts = [], company, notify }) {
    ...
    <>
      ...
      {loading ? (
        ...
        <section className="panel" style={{ padding: 28 }} aria-label="Buku Jurnal Umum">
          ...
          {/* Bagian Rekapitulasi Jurnal Umum (Sangat Khas Praktikum Akuntansi) */}
