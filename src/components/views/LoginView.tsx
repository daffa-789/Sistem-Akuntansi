...
import { PublicUser } from '../../../shared/types.js'

export interface LoginViewProps {
  onLogin: (user: PublicUser) => void
}

export function LoginView({ onLogin }: LoginViewProps): React.JSX.Element {
  const [email, setEmail] = useState<string>('admin@finova.local')
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      setError(r.message || 'Gagal masuk.')
    } finally {
      setBusy(false)
    }
  }
