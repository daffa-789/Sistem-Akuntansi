...
import { FieldWarning } from '../ui/FieldWarning.jsx'
...
import { AlereCheatSheetModal } from './AlereCheatSheetModal.jsx'
import { useLoad } from '../../hooks/useLoad.js'
import { request } from '../../api.js'
import { formatNum, parseNum, money, today, GL } from '../../utils/formatters.js'
import { validateJournal } from '../../utils/validators.js'

export function JournalModal({ accounts = [], entry, onClose, onSaved, notify }) {
  ...
  function autoFillAccounts() {
    ...
    const dDiff = debitLine.debit - creditLine.credit
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, width: '100%' }}>
                ...
                >
                  ...
                  {['ASSET', 'LIABILITY', 'EQUITY', 'REVENUE', 'EXPENSE'].map((grp) => {
