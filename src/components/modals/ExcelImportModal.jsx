...
export function ExcelImportModal({ onClose, notify, onImported }) {
  ...
  async function handlePreview() {
    ...
    try {
      const res = await request('/imports/preview', {
        method: 'POST',
        body: formData
      })
      setPreview(res)
  ...
  async function handleConfirm() {
    ...
    try {
      const res = await request(`/imports/${preview.batchId}/confirm`, {
        method: 'POST'
      })
